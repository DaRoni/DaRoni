...
Junior QA Engineer обладаю прочной технической базой, общий опыт работы в IT 13+ лет. Окончил курс «Тестирование ПО с нуля. Теория + практика». Прошёл Sandbox Mobile | Intensive "Mobile Testing Program". Ранее работал системным администратором в команде из 10 человек. Есть опыт работы с физическими и виртуальными серверами, настройка сетей (Routing, Firewalls, VPN servers), Windows Servers и Linux.
